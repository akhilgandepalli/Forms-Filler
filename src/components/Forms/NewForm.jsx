    ...
    <Box sx={{ maxWidth: 1200, mx: "auto", p: "2px" }}>
      <Paper elevation={3} sx={{ p: 2 }}>
        ...
        <Alert severity="info" sx={{ mb: 3 }}>
          Please complete all required fields. Sections 5 and 7 are for your appointed financial advisor to complete.
        </Alert>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Please select the type of application relevant to your profile, which will form the basis of your contract with us.
              </Typography>
          ...
          {applicationType === "existingDependant" && (
            <Card sx={{ mb: 3 }}>
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                  Complete this section if you're a dependant covered on an existing Stratum Benefits policy applying for your own policy.
                </Typography>
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <TextField
                          ...
                          helperText={errors.currentPolicyholderSurname?.message}
                        />
                      )}
                    />
                  </Grid>
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                We'll cover you and your spouse on one Gap Cover policy, even if you belong to different medical aids or medical aid plans, including the dependants registered on either medical aid plan.
              </Typography>
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Waiting periods apply from your and your dependants' cover start dates, but never to accidental events that occur after your start dates.
              </Typography>
                ...
                <Grid size={{xs:12, sm:6}}>
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        {["1st", "4th", "7th", "15th", "20th", "25th", "28th", "Last Day"].map((date) => (
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                As the policyholder, you understand and acknowledge that Gap Cover isn't a medical aid, doesn't provide similar cover as medical aid and can't be substituted for a medical aid membership.
              </Typography>
...
export default newForm; // Export the component as default